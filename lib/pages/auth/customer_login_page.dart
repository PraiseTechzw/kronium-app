...
class _CustomerLoginPageState extends State<CustomerLoginPage> {
  ...
  Future<void> _login() async {
    ...
    if (result['success']) {
      // Get user name for personalized welcome message
      ...
      ErrorHandler.showSuccessSnackbar(
        userName.isNotEmpty
            ...
            : 'Login successful! Welcome to KRONIUM! 🎉',
      );
                  ...
                  FadeInDown(
                    child: Column(
                      children: [
                        ...
                        Text(
                          'Sign in to your KRONIUM account to continue',
                          style: TextStyle(
                            fontSize: 16,
                  ...
                  FadeInUp(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () => Get.toNamed(AppRoutes.customerRegister),
                          child: Text(
                            'Sign Up',
                            style: TextStyle(
                              color: AppTheme.primaryColor,
