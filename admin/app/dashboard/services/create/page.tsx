...
export default function CreateServicePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showInfo('Creating service...', 'Please wait while we save your service')
      ...
      showSuccess('Service created successfully!', `${formData.title} has been added to your catalog`)
      ...
      showError('Failed to create service', 'Please check your input and try again')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-gray-600">Add a new service to your catalog</p>
        </div>
      </div>
